...
2. Open specmatic.yaml and run the suite. After the suite execution completes, in the right sidebar(Test Panel), click on the spec name tasks.yaml. This will open the Test tab for the spec, where you can view and analyze test results.
